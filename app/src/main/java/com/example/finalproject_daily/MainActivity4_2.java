...
public class MainActivity4_2 extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, View.OnClickListener,
                                                            DatePickerDialog.OnDateSetListener{

    Button btnEdit;
    EditText edtTitle, edtContent;
    Spinner spType;
    TextView tvTime, tvShowDate3;
    Calendar c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit = (Button)findViewById(R.id.btnUpdateNote);
        btnEdit.setOnClickListener(this);

        imgBtnBack = (ImageButton)findViewById(R.id.imgbtn_BackNote2);
        ...
        tvShowDate3 = (TextView) findViewById(R.id.tv_show_date_3);
        tvShowDate3.setOnClickListener(this);
    ...
    private void sendMessage() {
        ...
        bundle2.putString("newDate",tvShowDate3.getText().toString());
